...
public class DeliveryOnDeliveryOrdersCurrentOrderDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delivery_on_delivery_orders_current_order_details);
        initializeObjects();
        getIntentData();
        setTextValues();
        populateOrderList();
        ...
        saveButton.setOnClickListener(v -> {
            ...
            Intent getProofOfDeliveryIntent = new Intent(this, DeliveryProofOfDelivery.class);
            getProofOfDeliveryIntent.putExtra("current_order", onDeliveryOrdersConstructor);
            startActivity(getProofOfDeliveryIntent);
        });
    }
