...
public class DetailsAdapterOnDeliveryOrders extends RecyclerView.Adapter<DetailsAdapterOnDeliveryOrders.OnDeliveryOrdersDetailsViewHolder>{
    private final ArrayList<Map<String, Object>> orderItems;
    private final Context context;

    public DetailsAdapterOnDeliveryOrders(Context context, ArrayList<Map<String, Object>> orderItems) {
    ...
    @NonNull
    @Override
    public DetailsAdapterOnDeliveryOrders.OnDeliveryOrdersDetailsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_pending_order_details_card, parent, false);
        return new DetailsAdapterOnDeliveryOrders.OnDeliveryOrdersDetailsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DetailsAdapterOnDeliveryOrders.OnDeliveryOrdersDetailsViewHolder holder, int position) {
    ...
    public static class OnDeliveryOrdersDetailsViewHolder extends RecyclerView.ViewHolder{
        TextView txt_item_price, txt_item_id, txt_item_name;
        ImageView imv_item_img;

        public OnDeliveryOrdersDetailsViewHolder(@NonNull View itemView) {
            super(itemView);
