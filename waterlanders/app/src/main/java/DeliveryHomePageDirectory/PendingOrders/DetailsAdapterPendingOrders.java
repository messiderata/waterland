...
public class DetailsAdapterPendingOrders extends RecyclerView.Adapter<DetailsAdapterPendingOrders.PendingOrderDetailsViewHolder>{
    private final ArrayList<Map<String, Object>> orderItems;
    private final Context context;

    public DetailsAdapterPendingOrders(Context context, ArrayList<Map<String, Object>> orderItems) {
    ...
    @NonNull
    @Override
    public DetailsAdapterPendingOrders.PendingOrderDetailsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_pending_order_details_card, parent, false);
        return new PendingOrderDetailsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DetailsAdapterPendingOrders.PendingOrderDetailsViewHolder holder, int position) {
    ...
    public static class PendingOrderDetailsViewHolder extends RecyclerView.ViewHolder{
        TextView txt_item_price, txt_item_id, txt_item_name;
        ImageView imv_item_img;

        public PendingOrderDetailsViewHolder(@NonNull View itemView) {
            super(itemView);
