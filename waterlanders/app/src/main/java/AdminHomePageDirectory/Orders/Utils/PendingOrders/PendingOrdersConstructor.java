...
public class PendingOrdersConstructor implements Parcelable {
    ...
    public PendingOrdersConstructor() {
    }

    public PendingOrdersConstructor(String additional_message, Timestamp date_ordered, Map<String, Object> delivery_address, Map<String, Object> gcash_payment_details, String mode_of_payment, String order_icon, String order_id, List<Map<String, Object>> order_items, String order_status, int total_amount, String user_id) {
    ...
    protected PendingOrdersConstructor(Parcel in) {
    ...
    public static final Creator<PendingOrdersConstructor> CREATOR = new Creator<PendingOrdersConstructor>() {
        @Override
        public PendingOrdersConstructor createFromParcel(Parcel in) {
            return new PendingOrdersConstructor(in);
        }

        @Override
        public PendingOrdersConstructor[] newArray(int size) {
            return new PendingOrdersConstructor[size];
        }
    };
