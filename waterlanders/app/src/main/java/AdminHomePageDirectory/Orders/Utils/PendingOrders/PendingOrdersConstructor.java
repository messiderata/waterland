...
public class PendingOrdersConstructor implements Parcelable {
    ...
    public PendingOrdersConstructor(String additional_message, String date_delivery, Timestamp date_ordered, Map<String, Object> delivery_address, Map<String, Object> gcash_payment_details, String mode_of_payment, String order_icon, String order_id, List<Map<String, Object>> order_items, String order_status, String search_term, int total_amount, String user_id) {
