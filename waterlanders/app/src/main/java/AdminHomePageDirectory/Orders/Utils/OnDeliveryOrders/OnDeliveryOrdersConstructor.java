...
public class OnDeliveryOrdersConstructor implements Parcelable {
    ...
    public OnDeliveryOrdersConstructor(String additional_message, Timestamp date_ordered, Map<String, Object> delivery_address, String delivery_id, Map<String, Object> gcash_payment_details, String mode_of_payment, String order_icon, String order_id, List<Map<String, Object>> order_items, String order_status, int total_amount, String user_id) {
