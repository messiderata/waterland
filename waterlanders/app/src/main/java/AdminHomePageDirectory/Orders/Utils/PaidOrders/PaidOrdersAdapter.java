package AdminHomePageDirectory.Orders.Utils.PaidOrders;
...
public class PaidOrdersAdapter extends RecyclerView.Adapter<PaidOrdersAdapter.PaidOrdersAdapterViewHolder> {
    Context context;
    List<PendingOrdersConstructor> pendingOrdersConstructorList;

    public PaidOrdersAdapter(Context context, List<PendingOrdersConstructor> pendingOrdersConstructorList) {
        this.context = context;
        this.pendingOrdersConstructorList = pendingOrdersConstructorList;
    }

    public static class PaidOrdersAdapterViewHolder extends RecyclerView.ViewHolder {
        ImageView orderIMG;
        TextView orderID;
        TextView userID;
        TextView orderPrice;

        public PaidOrdersAdapterViewHolder(@NonNull View itemView) {
            super(itemView);
    ...
    @NonNull
    @Override
    public PaidOrdersAdapter.PaidOrdersAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_pending_orders_card, parent, false);
        return new PaidOrdersAdapter.PaidOrdersAdapterViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull PaidOrdersAdapter.PaidOrdersAdapterViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent showCurrentOrderDetailsIntent = new Intent(context, PaidOrdersCurrentOrdersDetails.class);
