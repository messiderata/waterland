...
public class PendingAccountsList extends AppCompatActivity {

    private ImageView backButton;
    private RecyclerView accountsListContainer;
    private List<ChatUsersConstructor> chatUsersConstructors;
    private PendingAccountsListAdapter pendingAccountsListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_pending_accounts_list);
        initializeObjects();
        setOnClickListeners();
        populateAccountList();
    }
    ...
    private void initializeObjects(){
        ...
        pendingAccountsListAdapter = new PendingAccountsListAdapter(this, chatUsersConstructors);
        accountsListContainer.setAdapter(pendingAccountsListAdapter);
            ...
            if (task.isSuccessful() && task.getResult() != null){
                ...
                for (DocumentSnapshot document : userList){
                    ...
                    if (!document.getId().equals(currentUserID)) {
                        ...
                        if (chatUsers != null && "PENDING".equals(chatUsers.getAccountStatus())){
                ...
                pendingAccountsListAdapter.notifyDataSetChanged();
            } else {
